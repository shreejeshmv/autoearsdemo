...
class TestUserModel:
    ...
    def test_user_has_unique_id(self) -> None:
        u1 = User(name="A")
        u2 = User(name="B")
        assert u1.id != u2.id
...
class TestNotificationModel:
    ...
    def test_notification_has_unique_id(self) -> None:
        n1 = Notification(user_id="u1", message="A")
        n2 = Notification(user_id="u1", message="B")
        assert n1.id != n2.id
